      ...
      <div className="flex flex-col pb-24 min-h-[70vh] items-center justify-center px-6">
        <div className="bg-white p-12 rounded-[32px] shadow-xl text-center max-w-lg w-full animate-in fade-in zoom-in-95">
          ...
          <button 
            ...
            className="w-full h-[60px] rounded-[20px] bg-[#f2ba4d] text-[#1a202c] font-bold text-[16px] hover:bg-[#e0a83b] transition-all"
          >
      ...
      <div className="px-6 md:px-12 lg:px-[80px] w-full max-w-[1400px] mx-auto -mt-16 md:-mt-20 relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 bg-white rounded-[24px] md:rounded-[32px] shadow-xl ring-1 ring-black/5 p-6 md:p-12">
            <h2 className="text-[26px] font-bold text-[#1a202c] mb-8 tracking-tight">Journey Details</h2>
            <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
              <div className="flex flex-col gap-2">
                <label className="text-[11px] font-bold text-[#1a202c] uppercase tracking-wider">Service Type *</label>
                <select 
                  className="w-full h-[54px] md:h-[64px] rounded-[16px] md:rounded-[20px] bg-[#f8f9fa] border-none px-4 text-[#1a202c] text-[15px] font-semibold focus:ring-2 focus:ring-[#f2ba4d] cursor-pointer"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                  <label className="text-[11px] font-bold text-[#1a202c] uppercase tracking-wider">Pickup Location *</label>
                  <input 
                    type="text" 
                    required
                    value={formData.pickup}
                    onChange={(e) => setFormData({...formData, pickup: e.target.value})}
                    className="w-full h-[54px] md:h-[64px] rounded-[16px] md:rounded-[20px] bg-[#f8f9fa] border-none px-4 text-[#1a202c] text-[15px] font-semibold focus:ring-2 focus:ring-[#f2ba4d]" 
                    placeholder="Airport, City, or Postcode" 
                  />
                </div>
                <div className="flex flex-col gap-2">
                  <label className="text-[11px] font-bold text-[#1a202c] uppercase tracking-wider">Drop-off Location *</label>
                  <input 
                    type="text" 
                    required
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                  <label className="text-[11px] font-bold text-[#1a202c] uppercase tracking-wider">Date *</label>
                  <input 
                    type="date" 
                    required
                    value={formData.date}
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-[11px] font-bold text-[#1a202c] uppercase tracking-wider">Time *</label>
                  <input 
                    type="time" 
                    required
                    value={formData.time}
              ...
              <div className="flex flex-col gap-2 mt-4">
                <label className="text-[11px] font-bold text-[#1a202c] uppercase tracking-wider">Select Vehicle *</label>
                <select 
                  required
              ...
              {formData.serviceType === "airport" && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                  <div className="flex flex-col gap-2">
                    <label className="text-[11px] font-bold text-[#1a202c] uppercase tracking-wider">Flight Number</label>
                    <input 
                      type="text" 
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="text-[11px] font-bold text-[#1a202c] uppercase tracking-wider">Luggage Count</label>
                    <input 
                      type="number" 
                      min="0" 
              ...
              <div className="mt-8 pt-8 border-t border-gray-100">
                <h3 className="text-[22px] font-bold text-[#1a202c] mb-6 tracking-tight">Contact Details</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex flex-col gap-2">
                    <input 
                      type="text" 
              ...
              <div className="mt-6">
                <p className="text-[13px] text-[#4a5568]/70 mb-6 font-semibold">By requesting a booking, you agree to our <Link to="/terms" className="text-black font-bold underline">Terms & Conditions</Link>.</p>
                
                {error && <p className="text-red-500 text-xs font-bold mb-4">{error}</p>}
                
                <button 
                  disabled={loading}
                  className="w-full h-[60px] md:h-[64px] rounded-[16px] md:rounded-[22px] bg-[#f2ba4d] text-brand-graphite font-bold text-[16px] hover:bg-[#e0a83b] hover:rounded-[12px] md:hover:rounded-[14px] transition-all mt-2 shadow-lg flex items-center justify-center gap-3 disabled:opacity-70"
                >
                  {loading ? (
                    <>
          ...
          <div className="lg:col-span-1 flex flex-col gap-6">
            <div className="bg-white rounded-[24px] md:rounded-[32px] shadow-xl ring-1 ring-black/5 p-8 border-t-4 border-[#f2ba4d]">
              ...
              <ul className="flex flex-col gap-6">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[14px] text-[#4a5568] leading-snug font-semibold">The quoted price remains fixed with no hidden fees or surge charges.</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-[#f8f9fa] flex items-center justify-center shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-[14px] text-[#4a5568] leading-snug font-semibold">Our dispatch team monitors flight numbers to adjust for delays automatically.</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-[#f8f9fa] flex items-center justify-center shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-[14px] text-[#4a5568] leading-snug font-semibold">Complete payment by card or cash directly to the driver at the end of the journey.</p>
                  </div>
                </li>
              </ul>
            </div>

            <div className="bg-[#2d3748] rounded-[24px] md:rounded-[32px] shadow-xl p-8 text-white relative overflow-hidden">
               ...
               <a href="tel:07459466835" className="inline-flex items-center justify-center w-full h-[56px] rounded-full hover:rounded-2xl bg-white text-[#1a202c] font-bold text-[16px] relative z-10 hover:bg-gray-100 transition-all">
                  07459 466835
               </a>
            </div>
          </div>
