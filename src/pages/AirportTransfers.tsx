  ...
  return (
    <div className="flex flex-col min-h-[70vh] pb-0">
      ...
      <div className="px-1 md:px-1.5 pt-1 md:pt-1.5">
        <div className="relative pt-[180px] pb-[140px] md:pt-[260px] md:pb-[200px] bg-[#2f3a43] overflow-hidden rounded-[12px] md:rounded-[22px] shadow-md ring-1 ring-black/[0.05]">
          ...
          <div className="absolute inset-0 z-10 bg-[#2f3a43]/60 backdrop-blur-[4px] mix-blend-multiply"></div>
          ...
          <div className="relative z-20 w-full max-w-[1400px] mx-auto px-6 text-center">
            ...
            <Link to="/book" className="inline-flex items-center justify-between gap-4 bg-[#f2ba4d] hover:bg-[#e0a83b] text-[#2a3036] font-bold text-[16px] h-[56px] px-2 pl-6 rounded-full hover:rounded-2xl transition-all mx-auto shadow-lg group">
              Book a transfer
              <div className="w-10 h-10 rounded-full bg-[#1a202c] flex items-center justify-center flex-shrink-0 text-white shadow-sm group-hover:scale-105 transition-transform">
      ...
      <div className="w-full max-w-[1400px] mx-auto px-6 md:px-12 lg:px-[80px] pt-16 lg:pt-24 pb-8 lg:pb-12">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center justify-between">
          <div className="flex-1 lg:max-w-xl">
            ...
            <div className="space-y-6 mb-10 text-[15px] text-[#2d3748]/70 font-semibold">
            ...
            <Link to="/book" className="inline-flex items-center justify-between gap-4 bg-[#2d3748] hover:bg-[#1a202c] text-white font-bold text-[16px] h-[56px] pl-6 pr-2 rounded-full hover:rounded-2xl transition-all w-fit shadow-md group">
              Book now
