    ...
    <div className="flex flex-col pb-24 min-h-[70vh]">
      ...
      <div className="px-1 md:px-1.5 pt-1 md:pt-1.5">
        <div className="relative pt-[110px] pb-20 md:pt-[130px] md:pb-28 bg-[#36404a] overflow-hidden rounded-[12px] md:rounded-[22px] shadow-md ring-1 ring-black/[0.05]">
          <div className="text-center w-full max-w-[1400px] mx-auto px-6 relative z-10">
            ...
            <h1 className="text-[30px] sm:text-3xl md:text-[34px] lg:text-[40px] font-bold text-white mb-5 leading-[1.05] tracking-tight">Privacy Policy</h1>
      ...
      <div className="px-6 md:px-12 w-full max-w-[1400px] mx-auto -mt-16 md:-mt-20 relative z-20">
        <div className="max-w-4xl mx-auto bg-white rounded-[32px] p-8 md:p-12 shadow-xl ring-1 ring-black/5 prose prose-slate">
          <h3 className="text-[16px] md:text-[18px] font-bold text-[#1a202c] mb-3 tracking-tight">1. Information We Collect</h3>
          ...
          <h3 className="text-[16px] md:text-[18px] font-bold text-[#1a202c] mb-3 tracking-tight">2. How We Use Your Data</h3>
          <p className="text-[#4a5568]/80 text-[14px] font-medium leading-relaxed mb-6 border-b border-gray-100 pb-6">
          ...
          <h3 className="text-[16px] md:text-[18px] font-bold text-[#1a202c] mb-3 tracking-tight">3. Data Sharing and Security</h3>
          <p className="text-[#4a5568]/80 text-[14px] font-medium leading-relaxed mb-6 border-b border-gray-100 pb-6">
          ...
          <h3 className="text-[16px] md:text-[18px] font-bold text-[#1a202c] mb-3 tracking-tight">4. Retention Period</h3>
          <p className="text-[#4a5568]/80 text-[14px] font-medium leading-relaxed mb-6 border-b border-gray-100 pb-6">
          ...
          <h3 className="text-[16px] md:text-[18px] font-bold text-[#1a202c] mb-3 tracking-tight">5. Your Rights</h3>
