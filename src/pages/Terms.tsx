    ...
    <div className="flex flex-col pb-24 min-h-[70vh]">
      ...
      <div className="px-6 md:px-12 w-full max-w-[1400px] mx-auto -mt-16 md:-mt-20 relative z-20">
        <div className="max-w-4xl mx-auto bg-white rounded-[32px] p-8 md:p-12 shadow-xl ring-1 ring-black/5 prose prose-slate">
          <h3 className="text-[18px] md:text-[20px] font-bold text-[#1a202c] mb-3 tracking-tight">1. General Bookings</h3>
          ...
          <h3 className="text-[18px] md:text-[20px] font-bold text-[#1a202c] mb-3 tracking-tight">2. Airport Transfers & Waiting Times</h3>
          <p className="text-[#4a5568]/80 text-[15px] font-semibold leading-relaxed mb-6 border-b border-gray-100 pb-6">
          ...
          <h3 className="text-[18px] md:text-[20px] font-bold text-[#1a202c] mb-3 tracking-tight">3. Cancellations</h3>
          <p className="text-[#4a5568]/80 text-[15px] font-semibold leading-relaxed mb-6 border-b border-gray-100 pb-6">
          ...
          <h3 className="text-[18px] md:text-[20px] font-bold text-[#1a202c] mb-3 tracking-tight">4. Luggage & Vehicle Capacity</h3>
          <p className="text-[#4a5568]/80 text-[15px] font-semibold leading-relaxed mb-6 border-b border-gray-100 pb-6">
          ...
          <h3 className="text-[18px] md:text-[20px] font-bold text-[#1a202c] mb-3 tracking-tight">5. Conduct & Cleaning</h3>
          <p className="text-[#4a5568]/80 text-[15px] font-semibold leading-relaxed mb-6 border-b border-gray-100 pb-6">
          ...
          <h3 className="text-[18px] md:text-[20px] font-bold text-[#1a202c] mb-3 tracking-tight">6. Liability</h3>
