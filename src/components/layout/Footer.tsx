  ...
  return (
    <footer className="bg-[#36404a] text-white pt-[64px] lg:pt-[80px] pb-8 px-6 md:px-12 lg:px-[80px] font-sans">
      <div className="w-full max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-0 mb-16 md:mb-24 lg:mb-32">
          {/* Brand Column */}
          ...
          <div className="lg:col-span-2 lg:pl-6 lg:border-l lg:border-white/10 pt-4 lg:pt-0">
            <ul className="space-y-[18px] text-[15px] font-semibold text-white">
              <li>
                <a href="#" className="hover:text-[#f2ba4d] transition-colors">
                  Facebook
                </a>
              </li>
              <li>
          ...
          <div className="lg:col-span-2 flex flex-col items-start lg:items-end pt-4 lg:pt-0">
            <Link
              to="/book"
              className="inline-flex items-center justify-between gap-4 bg-[#f2ba4d] hover:bg-[#e0a83b] text-[#2a3036] font-bold text-[16px] h-[56px] px-2 pl-6 rounded-full hover:rounded-2xl transition-all w-full lg:min-w-[170px] shadow-lg group"
            >
              Book now
              <div className="w-10 h-10 rounded-full bg-[#36404a] flex items-center justify-center flex-shrink-0 text-white shadow-sm border border-[#2a3036]/10 group-hover:scale-105 transition-transform">
