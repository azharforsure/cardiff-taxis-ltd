      ...
      <div className="w-full max-w-[1400px] mx-auto px-6 md:px-12 lg:px-[80px]">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 mb-16 items-start lg:items-end justify-between">
          <div className="flex-1 max-w-3xl">
            <span className="text-[15px] font-bold text-[#2d3748]/60 uppercase tracking-[0.2em] mb-4 block">
              FLEET & PRICING
            </span>
            ...
            <p className="text-[#4a5568]/80 text-[15px] font-normal leading-relaxed max-w-[800px]">
          ...
          <div className="flex gap-3 flex-col sm:flex-row shrink-0 lg:pt-8 w-full lg:w-auto ml-auto">
            <Link to="/book" className="w-full lg:w-auto">
              <button className="rounded-full hover:rounded-2xl pl-6 pr-1.5 py-1.5 bg-[#2d3748] text-white font-bold flex items-center justify-between gap-4 hover:bg-[#1a202c] transition-all w-full text-[16px] h-12 shadow-md">
                Book a transfer now
        ...
        <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 ${hideCta ? 'mb-0' : 'mb-24'}`}>
          {fleetRates.map((vehicle, index) => (
            <div
              key={index}
              className="group bg-[#f0f2f5] hover:bg-[#2d3748] border border-[#e2e8f0] hover:border-[#2d3748] rounded-[24px] p-6 lg:p-8 flex flex-col justify-between min-h-[200px] transition-all duration-300 shadow-sm hover:shadow-xl cursor-default"
            >
              <div>
                ...
                <h4 className="text-[18px] font-semibold text-[#1a202c] group-hover:text-[#ffb320] transition-colors duration-300">
                  {vehicle.name}
                </h4>
              </div>
              <div className="flex flex-col gap-2 mt-6">
                <div className="flex items-center justify-between border-b border-[#e2e8f0] group-hover:border-white/10 pb-2 transition-colors duration-300">
                  <span className="text-[14px] text-[#4a5568] group-hover:text-white/60 font-medium transition-colors duration-300">First mile</span>
                  <span className="text-[18px] font-bold text-[#1a202c] group-hover:text-white transition-colors duration-300">
                    {vehicle.firstMile}
                  </span>
                </div>
                <div className="flex items-center justify-between pt-1">
                  <span className="text-[14px] text-[#4a5568] group-hover:text-white/60 font-medium transition-colors duration-300">Remaining journey</span>
                  <span className="text-[16px] font-bold text-[#1a202c] group-hover:text-white transition-colors duration-300">
        ...
        {!hideCta && (
          <div className="bg-[#ebeef0] border border-[#e2e8f0] rounded-[24px] md:rounded-[32px] p-6 md:p-14 flex flex-col lg:flex-row gap-8 lg:gap-16 w-full">
            <div className="flex-1 lg:max-w-[420px]">
              <h3 className="text-[26px] font-bold text-[#1a202c] mb-4 leading-[1.2]">
                Need help arranging a specific transfer route
              </h3>
              <p className="text-[#4a5568] text-[14px] leading-[1.6] mb-10 font-normal">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="tel:07459466835" className="w-full sm:w-auto">
                  <button className="rounded-full hover:rounded-xl pl-6 pr-2 py-1.5 bg-[#2d3748] text-white font-bold flex items-center justify-between gap-4 hover:bg-[#1a202c] transition-all w-full sm:w-auto text-[16px] h-12">
                    Give us a call
            ...
            <div className="flex flex-col sm:flex-row gap-8 lg:gap-12 flex-1 lg:pt-2">
              <div className="flex-1">
                ...
                <h4 className="text-[18px] font-medium text-[#1a202c] mb-3 leading-[1.3]">
                  Flight tracking included.
                </h4>
                <p className="text-[#4a5568] text-[13px] leading-[1.6] font-normal">
