      ...
      <div className="w-full max-w-[1400px] mx-auto px-6 md:px-12 lg:px-[80px]">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 items-center">
          ...
          <div className="flex-1 flex flex-col items-start text-left max-w-2xl">
            ...
            <h3 className="text-[30px] sm:text-3xl md:text-[34px] lg:text-[40px] font-bold leading-[1.1] text-brand-primary mb-8 pr-4 tracking-tight">
              A local taxi service built on reliability
            </h3>
            
            <div className="space-y-6 text-[15px] text-brand-primary leading-relaxed mb-10 pr-0 md:pr-10 font-medium">
              <p>
            ...
            <Link to="/contact" className="w-full sm:w-auto">
              <button className="w-full sm:w-auto justify-between rounded-full hover:rounded-2xl pl-6 pr-1.5 py-1.5 bg-brand-primary text-white font-bold flex items-center gap-4 hover:bg-brand-graphite transition-all text-[16px] h-12 shadow-md">
                Contact us
                <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center shrink-0">
                  <ArrowRight className="w-3.5 h-3.5 text-brand-graphite" />
                </div>
              </button>
            </Link>
          </div>
